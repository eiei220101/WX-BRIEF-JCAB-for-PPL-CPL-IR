...
METAR_TAF_DEFAULT_AIRPORTS: list[dict[str, str]] = [
    ...
    # imoc 掲載「北九州・南九州」の全空港（metar.php Area=8,9）
    {"icao": "RJDT", "label": "対馬空港"},
    {"icao": "RJDB", "label": "壱岐空港"},
    {"icao": "RJFE", "label": "福江空港"},
    ...
    {"icao": "RJKI", "label": "喜界空港"},
    {"icao": "RJKA", "label": "奄美空港"},
    {"icao": "RJKN", "label": "徳之島空港"},
    {"icao": "RJKB", "label": "沖永良部空港"},
    {"icao": "RORY", "label": "与論空港"},
]
